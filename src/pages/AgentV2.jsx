...
<div className="mt-3 text-xs leading-5 text-slate-400">20 Properties Max Per Trial Batch</div>
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:items-stretch">
            ...
            <button onClick={startNewSession} disabled={!batchAnalyzed} className={`rounded-2xl px-5 py-4 text-sm font-semibold transition ${!batchAnalyzed ? "cursor-not-allowed border border-slate-800 bg-slate-900 text-slate-600" : "border border-amber-400/50 bg-amber-400/10 text-amber-200 hover:bg-amber-400/20"}`}>Start New Batch</button>
